...
def initialize_database():
    ...
    cursor.executemany("INSERT INTO gifts (name, price, description, link) VALUES (?, ?, ?, ?)", [
        ...
        ("Планшет", 22900, "Детский планшет для развлечений и обучения.", "https://www.olx.kz/d/kk/obyavlenie/planshet-detskiy-podarok-IDoZoRB.html"),
        ...
        ("Лего Duplo 10971", 5490, "Набор деталей Лего Duplo для детей.", "https://kaspi.kz/shop/p/lego-duplo-10971-detalei-10-sht-107451480/?c=750000000")
    ])
    conn.commit()
    conn.close()
